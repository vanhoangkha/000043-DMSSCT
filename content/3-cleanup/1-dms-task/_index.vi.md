...
2. Ở menu bên trái, chọn **Database migration tasks**, chọn vào từng migration task bạn đã tạo.
...
4. Xác nhận rằng bạn muốn dừng migration task.

![Delete](/images/3/3.png?width=90pc)

5. Sau khi trạng thái của migration task thay đổi thành **Stopped**, hãy chọn **Actions** một lần nữa và sau đó chọn **Delete**.

![Delete](/images/3/4.png?width=90pc)

6. Xác nhận rằng bạn muốn xóa migration task.
